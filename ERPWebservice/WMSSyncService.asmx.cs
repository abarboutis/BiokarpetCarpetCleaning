...
namespace WMSSyncService
{
    ...
    {
        static List<SyncERPItem>[] GItemList = new List<SyncERPItem>[30];
        static List<SyncLot>[] GLotList = new List<SyncLot>[30];
